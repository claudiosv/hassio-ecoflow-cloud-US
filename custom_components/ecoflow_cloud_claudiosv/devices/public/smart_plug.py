...
from custom_components.ecoflow_cloud_claudiosv.number import BrightnessLevelEntity
from custom_components.ecoflow_cloud_claudiosv.sensor import TempSensorEntity, VoltSensorEntity, AmpSensorEntity, \
