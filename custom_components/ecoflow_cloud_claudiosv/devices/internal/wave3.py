...
from custom_components.ecoflow_cloud_claudiosv import ECOFLOW_DOMAIN
...
from custom_components.ecoflow_cloud_claudiosv.devices import BaseDevice, const
from custom_components.ecoflow_cloud_claudiosv.number import LevelEntity
from custom_components.ecoflow_cloud_claudiosv.select import DictSelectEntity
...
class Wave3ClimateEntity(ClimateEntity):
    ...
    def __init__(self, client: EcoflowApiClient, device: Wave3):
        self._client = client
        self._device = device
        self._attr_device_info = {"identifiers": {(ECOFLOW_DOMAIN, device.device_info.sn)}}
