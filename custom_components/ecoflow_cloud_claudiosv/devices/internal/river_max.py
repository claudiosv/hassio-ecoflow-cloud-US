...
from custom_components.ecoflow_cloud_claudiosv.number import MaxBatteryLevelEntity
...
from custom_components.ecoflow_cloud_claudiosv.switch import EnabledEntity, BeeperEntity, FanModeEntity
