...
from custom_components.ecoflow_cloud_claudiosv.entities import BaseSensorEntity, BaseNumberEntity, BaseSwitchEntity, \
    BaseSelectEntity
from custom_components.ecoflow_cloud_claudiosv.number import ChargingPowerEntity, MinBatteryLevelEntity, MaxBatteryLevelEntity, \
    MaxGenStopLevelEntity, MinGenStartLevelEntity, BatteryBackupLevel
from custom_components.ecoflow_cloud_claudiosv.select import TimeoutDictSelectEntity
from custom_components.ecoflow_cloud_claudiosv.sensor import LevelSensorEntity, RemainSensorEntity, TempSensorEntity, \
    ...
    InEnergySensorEntity, OutEnergySensorEntity, \
...
class Delta2Max(BaseDevice):
    def sensors(self, client: EcoflowApiClient) -> list[BaseSensorEntity]:
        return [
            ...
            # Energy Device Class for Delta 2 Max for HA Energy Dashboard Config
